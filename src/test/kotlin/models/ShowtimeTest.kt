...
class ShowtimeTest {
    ...
    fun `endTime adds default padding and movie duration to startTime`() {
        ...
        assertEquals(baseTime.plusMinutes(135), showtime.endTime)
        // 120 min movie + 15 min default padding
    }
    ...
    fun `endTime uses custom padding when provided`() {
        ...
        assertEquals(baseTime.plusMinutes(150), showtime.endTime)
        // 120 min movie + 30 min padding
    }
}

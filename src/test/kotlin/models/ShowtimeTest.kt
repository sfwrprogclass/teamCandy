...
class ShowtimeTest {
    ...
    fun `endTime adds default padding and movie duration to startTime`() {
        val showtime = Showtime(movie = movie, startTime = baseTime, auditoriumNumber = 1, seatingChart = emptySeating)
    ...
    fun `endTime uses custom padding when provided`() {
        val showtime = Showtime(movie = movie, startTime = baseTime, auditoriumNumber = 1, seatingChart = emptySeating, paddingMinutes = 30)

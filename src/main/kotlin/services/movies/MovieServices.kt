...
class MovieServices {
    ...
    fun addMovie() {
        ...
        print("Enter an image URL for the movie: ")
        val imageUrl = readln()
    ...
    fun updateMovie() {
        ...
        if (choice in 1..movies.size) {
            ...
            print("New image URL (blank to keep current): ")
            val newImage = readln()
            if (newImage.isNotBlank()) selectedMovie.imageUrl = newImage
    ...
    fun viewMovies() {
        ...
        movies.forEach { movie ->
            ...
            println("Image URL: ${movie.imageUrl}\n")
        }
    }
